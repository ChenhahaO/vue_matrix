...
<template>
  <BranchNode
    v-model="_value" :readonly="readonly" :show-error="showErr" :error-info="errInfo"
    color="#59B9A4" header-icon="share" :is-default="isDefault"
    :content="content" :move-rn="moveRn" :move-ln="moveLn"
    :desc="`优先级 ${index + 1}`" @insert-node="type => emit('insertNode', type)"
