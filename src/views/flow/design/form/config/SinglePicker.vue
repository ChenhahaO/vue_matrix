...
<template>
  ...
  <el-form-item label="选项设置">
    <el-button style="margin: 7px" link type="primary" icon="plus" @click="addOption">
      添加选项
    </el-button>
    <VueDraggable v-model="config.props.options" class="w-fd-options" handle=".w-move" :animation="150">
