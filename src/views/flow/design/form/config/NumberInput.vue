...
<template>
  ...
  <el-form-item label="输入范围">
    <el-input v-model="config.props.min" type="number" style="width: 47%;" placeholder="最小值" />
    ~
    <el-input v-model="config.props.max" type="number" style="width: 47%;" placeholder="最大值" />
  </el-form-item>
